...
void Login() {
  ...
  if (usrInfo.size() < 4 || usrInfo[0] != "[UserName]" ||
      usrInfo[2] != "[UserType]") {
    FirstUse();
  } else {
...
void EP_PassWM() {
  ...
  for (cin >> num; num; cin >> num) {
    cout << "Enter the variable you want to change (1 ~ 3.Web-Site, Name, "
            "Password):\n";
    int id;
    cin >> id;
    cout << "Change to:";
    ...
    cout << "Completed.\n";
    cout
        << "Enter the password number you want to change. 0 means no change:\n";
  }
  system("pause");
  system("cls");
  PassWM();
...
void FW_WebSM() {
  ...
  for (int i = 1; i <= Count2; i++) {
    if (TmpArr[i].name == s) {
      findFlag = 1;
      cout << "The Web-Site is " << TmpArr[i].site << ", you are"
           << (TmpArr[i].star == "Yes" ? " " : " not ")
           << "stared this Web-Site.\n";
...
void EW_WebSM() {
  ...
  for (int i = 1; i <= Count2; i++) {
    cout << "Account " << i << ":\n";
    cout << "Name:" << TmpArr[i].name << ' ' << "Web-Site:" << TmpArr[i].site
         << ' ' << "Star:" << TmpArr[i].star << '\n';
  }
  cout << "Enter the password number you want to change. 0 means no change:\n";
  int num;
  for (cin >> num; num; cin >> num) {
    cout << "Enter the variable you want to change (1 ~ 3.Name, Web-Site, "
            "Star):\n";
    int id;
    cin >> id;
    cout << "Change to:";
